...
namespace GN.Library.Shared.Entities
{
    public class PhoneCallEntity : XrmDynamicEntity
    {
        ...
        public int State { get => GetAttributeValue<int>(Schema.State); set => SetAttributeValue(Schema.State, value); }
        ...
        public int Status { get => GetAttributeValue<int>(Schema.Status); set => SetAttributeValue(Schema.Status, value); }
        ...
        public void SetAsComplete()
        {
            ...
            this.Status = (int)PhoneCallEntity.Schema.StatusCodes.Recieved;
            this.State = (int)PhoneCallEntity.Schema.StateCodes.Completed;
           // this.dataServices.GetXrmOrganizationService().SetState(entity, messageContext.Message.Body.StateCode, messageContext.Message.Body.StatusCode);
        }
