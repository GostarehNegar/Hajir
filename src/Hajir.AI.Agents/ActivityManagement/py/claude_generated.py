...
def contact_agent_node(state: AgentState):
    ...
    1. Use search_contacts for finding contacts by name or company
...
def run_assistant(user_message: str, user_id: str = "USER_001"):
...
if __name__ == "__main__":
    # Example 1: Register a phone call
    run_assistant(
        "I just received a call from Ali Ahmadi. It lasted 15 minutes and we discussed the new products.",
        user_id="USER_001"
    )
    
    # Example 2: Search for a contact
    # run_assistant(
    #     "Can you find contacts from 'پارس' company?",
    #     user_id="USER_001"
    # )
