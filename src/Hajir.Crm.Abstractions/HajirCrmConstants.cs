...
namespace Hajir.Crm
{
    public partial class HajirCrmConstants
    {
        ...
        {
            public const string STR_Gaurantee = "دستگاه {نام دستگاه} دارای {مدت گارانتی} گارانتی و 10 سال خدمات پس از فروش میباشد.";
            public const string STR_BATTERY_GAURANTEE = "باتری {نام باتری} دارای {مدت گارانتی} ماه گارانتی میباشد.";
            ...
            public const string STR2 = "کالا آماده تحویل بوده و مدت ارسال {مدت ارسال} روز کاری پس از تایید می باشد. ";
            public const string STR3 = "کالا آماده تحویل بوده و مدت ارسال {مدت ارسال} روز کاری پس از تسویه حساب می باشد.";
            public const string STR4 = "مدت ارسال {مدت ارسال} روز کاری پس از دریافت {پیش پرداخت} درصد پیش پرداخت می باشد.";
            ...
            public const string STR8 = "مدت اعتبار پیش فاکتور {مدت اعتبار} روز می باشد. ";
            ...
            {
                return (HajirCrmConstants.QuoteComments.STR_Gaurantee + "\r\n" +
