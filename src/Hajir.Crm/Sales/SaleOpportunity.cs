...
namespace Hajir.Crm.Sales
{
    public class SaleOpportunity
    {
        ...
        public SaleOpportunity RecalculateBundles()
        {
        ...
        public SaleOpportunity AddLine(SaleQuoteLine line)
        {
        ...
        public SaleOpportunity RemoveLine(SaleQuoteLine line)
        {
            this.DeletedLines.Add(line);
            _lines.Remove(line);
            return this;
        }
        public SaleOpportunity(string quoteId, string quoteNumber, IEnumerable<SaleQuoteLine> lines,
             PriceList pl)
        {
            QuoteId = quoteId;
        ...
        public SaleOpportunity Validate()
        {
            ReorderLines();
            return this;
        }
